...
if __name__ == "__main__":
    ...
    for speaker in speaker_names:
        ...
        wavfiles = [f for f in files if not f.startswith('processed_') and f.endswith('.wav')]
        processed_files = 0
        ...
        for i, wavfile in enumerate(wavfiles):
            ...
            # 替换原wav文件
            save_path = parent_dir + speaker + "/" + wavfile
            ...
            if lang not in list(lang2token.keys()):
                ...
                # raise ValueError(f"{lang} not supported, ignoring\n")
                continue
            text = "ZH|" + text + "\n"#
